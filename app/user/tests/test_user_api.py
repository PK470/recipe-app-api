...
class PUblicUserApiTests(TestCase):
    """Test the users API publically available."""
    ...
    def test_password_too_short_error(self):
        """Test that a password too short returns an error."""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': 'Test Name',
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        self.user = create_user(email='test@example.com', password='test123',name = 'Test Name')
        self.client = APIClient()
